        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
          ...
          className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full">
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h3 className="text-center font-bold text-gray-800 text-lg mb-4">Tính năng dành cho Sinh viên</h3>
          ...
          {/* --- CARD 2: Tutor (Link tới trang upload cũ) --- */}
          <div 
            onClick={() => navigate('/resources/upload')} // <--- Bấm vào đây để sang trang Upload
          ...
          >
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h3 className="text-center font-bold text-gray-800 text-lg mb-4">Tính năng dành cho Tutor</h3>
              <div className="border-t pt-4 flex justify-between items-center text-sm mt-auto">
                <span className="text-green-600 font-medium cursor-pointer hover:underline">Bấm để xem</span>
                <span className="text-gray-800 font-bold cursor-pointer hover:underline">View more</span>
              </div>
          ...
          {/* --- CARD 3: Lịch sử --- */}
            <div 
            onClick={() => navigate('/resources/history')} // <--- THÊM DÒNG NÀY
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h3 className="text-center font-bold text-gray-800 text-lg mb-4">Lịch sử truy cập</h3>
              <div className="border-t pt-4 flex justify-between items-center text-sm mt-auto">
                <span className="text-green-600 font-medium cursor-pointer hover:underline">Bấm để xem</span>
                <span className="text-gray-800 font-bold cursor-pointer hover:underline">View more</span>
              </div>
